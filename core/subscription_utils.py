...
def get_or_create_free_subscription(user):
    ...
    if not free_plan:
        ...
        free_plan = Plan.objects.create(
            ...
            features=[
                {
                    "code": "ig_flow_builder",
                    "limit": 1,
                    "description": "Active DM Flows",
                },
                ...
                {"code": "ig_quick_replies", "description": "Quick reply buttons"},
                {"code": "ig_follower_check", "description": "Follower check branching"},
            ],
            is_active=True,
            order=0,
        )
